      ...
      <section className="border-2 border-main-purple rounded-2xl p-4 mt-10 lg:w-9/12 lg:mx-auto">
        <div className="bg-light-grey rounded-2xl p-4">
          ...
          <p className="text-gray-500 text-base lg:text-lg font-normal mt-8">
            Roster of Care describes the supports you’ll get from Hola Support,
            it helps the NDIS to decide how much support to include in your
            plan. We will work with to create or update your Roster of Care, if
            your needs have changed, you may have to get a report from a
            qualified Allied Health Practitioner [AHP] to show this to the NDIS.
          </p>
          <h1 className="text-gray-500 text-base lg:text-lg font-semibold mt-8">
            What is included in SIL
          </h1>
          <ul className="mt-10 list-disc">
            {includedSil.map((_skills, idx) => (
          ...
          <ul className="mt-10 list-disc">
            {notIncludedSil.map((_notSkills, id) => (
